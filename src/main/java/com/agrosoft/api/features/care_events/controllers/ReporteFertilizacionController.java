...
public class ReporteFertilizacionController {
    ...
    @PostMapping
    public ResponseEntity<ApiResponse<ReporteFertilizacionEntity>> crearReporte(@RequestBody ReporteFertilizacionRequestDTO request) {
    ...
    public ResponseEntity<ApiResponse<ReporteFertilizacionEntity>> obtenerPorEvento(@PathVariable UUID idEvento) {
    ...
    public ResponseEntity<ApiResponse<ReporteFertilizacionEntity>> actualizarReporte(
